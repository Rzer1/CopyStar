            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="row mb-3">
                            <label for="firstname" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Имя')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="lastname" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Фамилия')); ?></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/users/jdzaexvz/ydyharf-m1/resources/views/auth/register.blade.php ENDPATH**/ ?>